...
//    public static final String BASE_URL = "http://3.21.32.66/clicktofoodapi/api/Agents/";  // latest production server given by shawn bhai, aws server

    public static final String BASE_URL = "https://c2dagent.com/papi/api/Agents/";  // latest production server given by shimul bhai, new server due to aws server bill payment failure
